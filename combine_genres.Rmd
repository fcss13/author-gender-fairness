...
ggplot(combined_data_df, 
  ...
  ggtitle("Comparison of mean bootstrapped recgaps, by algorithm and genre. \nWhiskers indicate 95% confidence intervall.") +
...
panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  ...
  ggtitle("Regression of mean bootstrapped recgap and reviewgap, by every algortihm")
```
